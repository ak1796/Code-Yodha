  ...
  return (
    ...
    <footer className="py-20 bg-[#162F6A] text-center">
       <div className="max-w-7xl mx-auto px-6">
          <h4 className="text-2xl font-sora font-extrabold text-white">{t('FooterTagline')}</h4>
          <p className="text-sm text-white/60 mt-2 font-medium">{t('PlatformCopyright')} &copy; 2026</p>
       </div>
    </footer>
    </div>
  );
